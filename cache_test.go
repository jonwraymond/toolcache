...
func TestSentinelErrors(t *testing.T) {
	tests := []struct {
		...
		{"ErrNilCache", ErrNilCache, "toolcache: cache is nil"},
		{"ErrInvalidKey", ErrInvalidKey, "toolcache: key is invalid"},
		{"ErrKeyTooLong", ErrKeyTooLong, "toolcache: key exceeds max length"},
	}
